...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 98765 00009.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Wealth Era Property Solutions · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="JLPL Industrial Area · Sector 126 · Mohali" />
              ...
              <a href="tel:+919876500009" className="bm-call">Or call the desk · +91 98765 00009</a>
            </aside>
          </form>
        )}
      </div>
