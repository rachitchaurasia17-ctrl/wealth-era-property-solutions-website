...
Firm facts:
- Firm: Wealth Era Property Solutions
- Office: JLPL Industrial Area, Sector 79, Sahibzada Ajit Singh Nagar, Punjab 140308
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 98765 00009 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
